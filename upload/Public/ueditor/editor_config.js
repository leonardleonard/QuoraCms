...
,toolbars:[["Undo","Redo","InsertUnorderedList","InsertOrderedList","Unlink","Link","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","InsertImage","scrawl","music","SnapScreen","InsertVideo","Attachment","Map","Spechars","BlockQuote","HighlightCode","Bold","Italic","Underline","StrikeThrough"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'undo':'','redo':'','insertunorderedlist':'','insertorderedlist':'','unlink':'','link':'','insertimage':'','scrawl':'','music':'','snapscreen':'','insertvideo':'','attachment':'','map':'','spechars':'','blockquote':'','highlightcode':'','bold':'','italic':'','underline':'','strikethrough':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':''}
...
,initialFrameWidth:682  //初始化编辑器宽度,默认1000
...
,initialStyle:'body{font-size:14px;color:#888;font-family:"微软雅黑"}'   //编辑器内部样式,可以用来改变字体等
